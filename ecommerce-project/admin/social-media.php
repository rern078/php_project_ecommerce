...
if (isset($_POST['form1'])) {
	...
	$statement = $pdo->prepare("UPDATE tbl_social SET social_url=? WHERE social_name=?");
	$statement->execute(array($_POST['telegram'], 'Telegram'));
...
foreach ($result as $row) {
	...
	if ($row['social_name'] == 'Telegram') {
		$telegram = $row['social_url'];
	}
			...
			<form class="form-horizontal" action="" method="post">
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Telegram </label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="telegram" value="<?php echo $telegram; ?>">
							</div>
						</div>
