 ...
 <script src="<?php echo $IncPath ?>/content/<?php echo $ecommerce ?>/js/contact.js" type="text/javascript"></script>
 <script src="<?php echo $IncPath ?>/content/<?php echo $ecommerce ?>/js/contact.js" type="text/javascript"></script>
 ...
 <script src="<?php echo $IncPath ?>/content/<?php echo $ecommerce ?>/js/jquery-3.7.1.min.js" type="text/javascript"></script>
 <!-- Owl Carousel CSS -->
