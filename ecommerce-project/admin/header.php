	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">ChamrerN ShoP</span>
			</a>
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview <?php if (($cur_page == 'size.php') || ($cur_page == 'size-add.php') || ($cur_page == 'size-edit.php') || ($cur_page == 'color.php') || ($cur_page == 'color-add.php') || ($cur_page == 'color-edit.php') || ($cur_page == 'country.php') || ($cur_page == 'country-add.php') || ($cur_page == 'country-edit.php') || ($cur_page == 'shipping-cost.php') || ($cur_page == 'shipping-cost-edit.php') || ($cur_page == 'top-category.php') || ($cur_page == 'top-category-add.php') || ($cur_page == 'top-category-edit.php') || ($cur_page == 'mid-category.php') || ($cur_page == 'mid-category-add.php') || ($cur_page == 'mid-category-edit.php') || ($cur_page == 'end-category.php') || ($cur_page == 'end-category-add.php') || ($cur_page == 'end-category-edit.php')) {
						...
						<ul class="treeview-menu">
							<li class="<?php echo ($currentPage == 'size.php') ? 'active' : '' ?>"><a href="size.php"><i class="fa fa-circle-o"></i> Size</a></li>
							<li class="<?php echo ($currentPage == 'color.php') ? 'active' : '' ?>"><a href="color.php"><i class="fa fa-circle-o"></i> Color</a></li>
							<li class="<?php echo ($currentPage == 'country.php') ? 'active' : '' ?>"><a href="country.php"><i class="fa fa-circle-o"></i> Country</a></li>
							<li class="<?php echo ($currentPage == 'shipping-cost.php') ? 'active' : '' ?>"><a href="shipping-cost.php"><i class="fa fa-circle-o"></i> Shipping Cost</a></li>
							<li class="<?php echo ($currentPage == 'top-category.php') ? 'active' : '' ?>"><a href="top-category.php"><i class="fa fa-circle-o"></i> Top Level Category</a></li>
							<li class="<?php echo ($currentPage == 'mid-category.php') ? 'active' : '' ?>"><a href="mid-category.php"><i class="fa fa-circle-o"></i> Mid Level Category</a></li>
							<li class="<?php echo ($currentPage == 'end-category.php') ? 'active' : '' ?>"><a href="end-category.php"><i class="fa fa-circle-o"></i> End Level Category</a></li>
						</ul>
					</li>
