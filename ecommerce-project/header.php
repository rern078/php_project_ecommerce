		...
		<div class="container">
			<div class="row inner">
				<div class="col-md-4 logo">
					<a href="/"><img src="assets/uploads/<?php echo $logo; ?>" alt="logo image"></a>
				</div>
					...
					<div class="menu-container">
						<div class="menu">
							<ul>
								...
								foreach ($result as $row) {
								?>
									<li><a href="product-category?id=<?php echo $row['tcat_id']; ?>&type=top-category"><?php echo $row['tcat_name']; ?></a>
										<ul>
											<?php
											...
											foreach ($result1 as $row1) {
											?>
												<li><a href="product-category?id=<?php echo $row1['mcat_id']; ?>&type=mid-category"><?php echo $row1['mcat_name']; ?></a>
													<ul>
														<?php
														...
														foreach ($result2 as $row2) {
														?>
															<li><a href="product-category?id=<?php echo $row2['ecat_id']; ?>&type=end-category"><?php echo $row2['ecat_name']; ?></a></li>
														<?php
														}
														?>
													</ul>
								...
								<li><a href="faq"><?php echo $faq_title; ?></a></li>
